...
This object will add tremolo markings to a pair of RestChords of the proper duration. The object should be placed between
...
local spec_Tremolo = {
	Bars = { type='int', default=3, min=1, max=4 },
